...
The visual reviewer chooses a relevant original source photograph or legible official graphic, and the draft path imports it into the WordPress media library with descriptive alt text and source credit, sets it as featured media, and verifies the saved attachment. A clear smaller source graphic can accompany a nonpublic draft; the 1200-by-600 minimum for automatic publication remains unchanged. Missing or unsuitable images are recorded in the report. An attempted image upload failure leaves the item retryable instead of saving and permanently consuming a broken draft.
