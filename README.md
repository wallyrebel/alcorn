...
4. A source image is preferred. If missing, unavailable or too small, an optional Pexels fallback may supply an explicitly labeled stock illustration for appropriate topics (see below). Every image must decode correctly, be at least 1200 by 600 pixels, and pass visual review. A missing or unsuitable image blocks publication.
